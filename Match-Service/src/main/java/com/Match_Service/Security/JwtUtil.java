...
/**
 * JWT Utility for Match Service.
 *
 * CRITICAL: This secret key MUST be identical to User Service's JwtUtil.
 * Both services sign and verify tokens independently using the same HMAC key.
 *
 * In production, externalize this to a shared config (e.g., Vault, Config Server).
 *
...
public class JwtUtil {
     ...
     * (Match Service doesn't typically generate tokens, but this is here for completeness)
     */
